    ...
    public function wishlistStore(Request $request)
    {
       ...
       if(in_array($product_id,$wishlist_array)){
        ...
        $response['message']="Item is already in your wishlist";
           ...
           $result=Cart::instance('wishlist')->add($product_id,$product[0]['title'],$product_qty,$price)->associate('App\Models\Product'); //getproduct details to widhlist
       ...
       {   
        ...
        $item=Cart::instance('wishlist')->get($request->input('rowId'));
           //dd($item);
         Cart::instance('wishlist')->remove($request->input('rowId')); //remove item in cart & pass the wishlist
