                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12  col-sm-12">  
                                 ...
                                 <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="10%" name="value" value="{{$coupon->value}}">
                                    </div>
                                ...
                                <div class="col-lg-12  col-sm-12">
                                    ...
                                    <select name="status" class="form-control show-tick">
                                        ...
                                        <option value="inactive" {{$coupon->staus=='inactive' ? 'selected' : ''}}>Inactive</option>
                                    </select>
                                </div>
                            </div>
