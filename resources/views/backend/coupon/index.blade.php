            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <a class="btn btn-sm btn-outline-secondary" href="{{route('coupon.create')}}"><i class="icon-plus"></i>Add Coupon</a></h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                     ...
                                     <td>
                                        <a href="{{route('coupon.edit',$item->id)}}" class="float-left btn btn-sm btn-outline-warning" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
