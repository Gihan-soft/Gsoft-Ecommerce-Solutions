                            ...
                            <div class="table-responsive">
                               <table class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <a href="{{route('order.show',$order->id)}}" class="float-left btn btn-sm btn-outline-warning" data-toggle="tooltip" title="download" data-placement="bottom"><i class="fas fa-download"></i></a>
                            ...
                            <div class="col-5 border py-3">
                                ...
                                <form action="{{route('order.status')}}" method="post">
                                    ...
                                    <select name="condition" class="form-control" id="">
                                        ...
                                        <option value="processing" {{$order->condition=='delivered' || $order->condition=='cancelled' ? 'disabled' : ''}}>Processing</option>
                                        <option value="delivered" {{$order->condition=='cancelled' ? 'disabled' : ''}} {{$order->condition=='delivered' ? 'disabled' : ''}} >Delivered</option>
