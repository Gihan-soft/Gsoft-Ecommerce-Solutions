                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="delivery_time" name="delivery_time" value="{{$shipping->delivery_time}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Dlivery Charge" name="delivery_charge" value="{{$shipping->delivery_charge}}">
                                    </div>
