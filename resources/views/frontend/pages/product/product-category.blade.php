                ...
                <div class="col-12">
                    ...
                    <div class="shop_top_sidebar_area d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <select id="sortBy"  class="small right">
                            ...
                            <option value="priceAsc" {{old('sortBy')=='priceAsc' ? 'selected' : ''}}>Price-Lower To High</option>
                            <option value="priceDesc">Price Higher To Lower</option>
                            <option value="titleAsc">Alphabatical Ascending</option>
                            <option value="titleDesc">Alphabatical Decending</option>
                             <option value="discAsc">Discount -Lower To High</option>
                    ...
                    <!-- Shop Pagination Area -->
                       ...
                       <div class="ajax-load text-center" style="display:none">
                          <img src="{{asset('frontend/img/loader.gif')}}" style="width:6%;height:6%">
                     </div>
                </div>
            </div>
        </div>
...
<script>
    function loadmoreData(page)
    {
        ...
        .done(function(data){
              if(data.html==''){
                  $('#ajax-load').html("No more data avalable");
                  return;
              }
               $('#ajax-load').hide();
    ...
    var page=1;
    $(window).scroll(function (){     //load more products when scroll down
