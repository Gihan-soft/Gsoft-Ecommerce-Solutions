                    ...
                    <div class="single_product_desc">
                       ...
                       <!-- <div class="widget p-0 color mb-3">
                        ...
                        <form class="cart clearfix my-5 d-flex flex-wrap align-items-center" method="post">
                            ...
                            <button type="button" name="addtocart" data-product_id="{{$product->id}}" data-quantity="1" data-price="{{$product->offer_price}}" id="add_to_cart_button_details_{{$product->id}}" value="5" class="btn btn-primary mt-1 mt-md-0 ml-1 ml-md-3">Add to cart</button>
                        </form>
                    ...
                    <div class="product_details_tab section_padding_100_0 clearfix">
                        ...
                        <div class="tab-content">
                          ...
                          {!! html_entity_decode($product->description) !!}
                            ...
                            <div role="tabpanel" class="tab-pane fade show-active" id="reviews"></div>
                             <div class="submit_a_review_area mt-50">
                                    <h4>Submit A Review123</h4>
                                    @auth
