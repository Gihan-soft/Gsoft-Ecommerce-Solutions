<div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="user-name"><strong>{{ucfirst(auth('seller')->user()->full_name)}}</strong>&nbsp;<span>@if(auth('seller')->user()->is_verified) <i class="fas fa-check-circle text-success" data-toggle="tooltip" title="verified" data-placement="bottom"></i>  @else <i class="fas fa-user-times text-danger" data-toggle="tooltip" title="unverified" data-placement="bottom"></i>   @endif</span></a>
                </div>
                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="active"><a href="/admin"><i class="icon-grid"></i><span>Dashboard</span></a></li>
