            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <a class="btn btn-sm btn-outline-secondary" href="{{route('seller-product.create')}}"><i class="icon-plus"></i>Add Product</a></h2>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped " style="width:100%">
                                    ...
                                    <tbody>
                                     ...
                                     <td>
                                        <a href="{{route('seller-product.show',$item->id)}}"  class="float-left btn btn-sm btn-outline-secondary" data-toggle="tooltip" title="add attribute" data-placement="bottom"><i class="fas fa-plus-circle"></i></a>
                                        ...
                                        <a href="{{route('seller-product.edit',$item->id)}}" class="float-left btn btn-sm btn-outline-warning" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                        <form class="float-left ml-1" action="{{route('seller-product.destroy',$item->id)}}" method="POST">
                                            @csrf
                                            @method('delete')
